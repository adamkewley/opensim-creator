...
static constexpr std::array<char const* const, static_cast<size_t>(gl::ShaderType::TOTAL)> g_ShaderTypeNames = OSC_GLSL_SHADERTYPE_NAMES;
static constexpr std::array<int, static_cast<size_t>(gl::ShaderType::TOTAL)> g_ShaderLocationsTakenBy = {
    1,  // Float
    1,  // Int
    1,  // Sampler2D
    1,  // Sampler2DMS
...
static constexpr std::array<int, static_cast<size_t>(gl::ShaderType::TOTAL)> g_ShaderElementsPerLocation = {
    1,  // Float
    1,  // Int
    1,  // Sampler2D
    1,  // Sampler2DMS
...
{
    return o << g_ShaderTypeNames.at(static_cast<size_t>(s));
}

int gl::GetNumShaderLocationsTakenBy(ShaderType t)
{
    return g_ShaderLocationsTakenBy.at(static_cast<size_t>(t));
}

int gl::GetNumElementsPerLocation(ShaderType t)
{
    return g_ShaderElementsPerLocation.at(static_cast<size_t>(t));
}
...
void gl::SetUniform(Uniform<ShaderType::Float>& u, GLfloat value)
{
