...
namespace gl {
    ...
    inline void UniformMatrix3fv(Uniform<Glsl_Mat3>& u, glm::mat3 const& mat) noexcept
    {
        gl::UniformMatrix3fv(u.geti(), 1, false, glm::value_ptr(mat));
    }

    inline void Uniform4fv(Uniform<Glsl_Vec4>& u, glm::vec4 const& v) noexcept
    {
        gl::Uniform4fv(u.geti(), 1, glm::value_ptr(v));
    }

    inline void Uniform3fv(Uniform<Glsl_Vec3>& u, glm::vec3 const& v) noexcept
    {
        gl::Uniform3fv(u.geti(), 1, glm::value_ptr(v));
    }

    inline void Uniform3fv(Uniform<Glsl_Vec3>u, GLsizei n, glm::vec3 const* vs) noexcept
    {
        static_assert(sizeof(glm::vec3) == 3 * sizeof(GLfloat));
        gl::Uniform3fv(u.geti(), n, glm::value_ptr(*vs));
    }

    inline void UniformMatrix4fv(Uniform<Glsl_Mat4>& u, glm::mat4 const& mat) noexcept
    {
        gl::UniformMatrix4fv(u.geti(), 1, false, glm::value_ptr(mat));
    }

    inline void UniformMatrix4fv(Uniform<Glsl_Mat4>& u, GLsizei n, glm::mat4 const* first) noexcept
    {
        static_assert(sizeof(glm::mat4) == 16 * sizeof(GLfloat));
        gl::UniformMatrix4fv(u.geti(), n, false, glm::value_ptr(*first));
    }

    inline void Uniform2fv(Uniform<Glsl_Vec2>& u, glm::vec2 const& v) noexcept
    {
        gl::Uniform2fv(u.geti(), 1, glm::value_ptr(v));
    }

    inline void Uniform2fv(Uniform<Glsl_Vec2>& u, GLsizei n, glm::vec2 const* vs) noexcept
    {
