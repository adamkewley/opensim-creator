...
namespace
{
    static constexpr std::array<char const*, static_cast<size_t>(osc::MeshTopography2::TOTAL)> const g_MeshTopographyStrings =
    {
        "Triangles",
        "Lines",
    };

    static constexpr std::array<char const*, static_cast<size_t>(osc::TextureWrapMode::TOTAL)> const g_TextureWrapModeStrings =
    {
        "Repeat",
        "Clamp",
        "Mirror",
    ...
    static constexpr std::array<char const*, static_cast<size_t>(osc::TextureFilterMode::TOTAL)> const g_TextureFilterModeStrings =
    {
        "Nearest",
        "Linear",
        "Mipmap",
    ...
    static constexpr std::array<char const*, static_cast<size_t>(osc::ShaderType::TOTAL)> g_ShaderTypeStrings =
    {
        "Float",
        "Int",
        "Matrix",
    ...
    static constexpr std::array<char const*, static_cast<size_t>(osc::ShaderType::TOTAL)> g_CameraProjectionStrings =
    {
        "Perspective",
        "Orthographic",
    };
...
public:
    ...
    Impl(MeshTopography2 t, nonstd::span<glm::vec3 const> verts) :
    ...
    void setTopography(MeshTopography2 mt)
    {
        m_Topography = mt;
        m_VersionCounter++;
    }
    ...
    void recalculateBounds()
    {
        ...
        if (m_Topography == MeshTopography2::Triangles)
        {
...
private:
    ...
    MeshTopography2 m_Topography = MeshTopography2::Triangles;
...
std::ostream& osc::operator<<(std::ostream& o, MeshTopography2 t)
{
    return o << g_MeshTopographyStrings.at(static_cast<size_t>(t));
}

std::string osc::to_string(MeshTopography2 t)
{
...
osc::Mesh::Mesh(MeshTopography2 t, nonstd::span<glm::vec3 const> verts) :
...
osc::MeshTopography2 osc::Mesh::getTopography() const
{
    return m_Impl->getTopography();
}

void osc::Mesh::setTopography(MeshTopography2 mt)
{
...
osc::UID osc::StorePropertyNameToUID(std::string_view)
{
    throw std::runtime_error{"todo"};
}

std::optional<std::string_view> osc::TryLoadPropertyNameFromUID(UID)
{
    throw std::runtime_error{"todo"};
}
...
osc::Shader::Shader(char const* src) :
...
std::optional<int> osc::Shader::findPropertyIndex(std::string_view propertyName) const
{
    return m_Impl->findPropertyIndex(std::move(propertyName));
}

std::optional<int> osc::Shader::findPropertyIndex(UID propertyNameID) const
{
...
bool osc::Material::hasProperty(UID propertyNameID) const
{
...
float const* osc::Material::getFloat(std::string_view propertyName) const
{
    return m_Impl->getFloat(std::move(propertyName));
}

float const* osc::Material::getFloat(UID propertyNameID) const
{
...
void osc::Material::setFloat(UID propertyNameID, float v)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setFloat(std::move(propertyNameID), std::move(v));
}

int const* osc::Material::getInt(std::string_view propertyName) const
{
    return m_Impl->getInt(std::move(propertyName));
}

int const* osc::Material::getInt(UID propertyNameID) const
{
...
void osc::Material::setInt(UID propertyNameID, int v)
{
    DoCopyOnWrite(m_Impl);
...
osc::Texture2D const* osc::Material::getTexture(UID propertyNameID) const
{
    return m_Impl->getTexture(std::move(propertyNameID));
}

void osc::Material::setTexture(std::string_view propertyName, Texture2D const& t)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setTexture(std::move(propertyName), std::move(t));
}

void osc::Material::setTexture(UID propertyNameID, Texture2D const& t)
{
    DoCopyOnWrite(m_Impl);
...
glm::vec4 const* osc::Material::getVector(UID propertyNameID) const
{
...
void osc::Material::setVector(UID propertyNameID, glm::vec4 const& v)
{
    DoCopyOnWrite(m_Impl);
...
glm::mat4 const* osc::Material::getMatrix(UID propertyNameID) const
{
...
void osc::Material::setMatrix(UID propertyNameID, glm::mat4 const& m)
{
    DoCopyOnWrite(m_Impl);
...
bool osc::MaterialPropertyBlock::hasProperty(UID propertyNameID) const
{
    return m_Impl->hasProperty(std::move(propertyNameID));
}
...
float const* osc::MaterialPropertyBlock::getFloat(std::string_view propertyName) const
{
    return m_Impl->getFloat(std::move(propertyName));
}

float const* osc::MaterialPropertyBlock::getFloat(UID propertyNameID) const
{
    return m_Impl->getFloat(std::move(propertyNameID));
}
...
void osc::MaterialPropertyBlock::setFloat(UID propertyNameID, float v)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setFloat(std::move(propertyNameID), std::move(v));
}

int const* osc::MaterialPropertyBlock::getInt(std::string_view propertyName) const
{
    return m_Impl->getInt(std::move(propertyName));
}

int const* osc::MaterialPropertyBlock::getInt(UID propertyNameID) const
{
    return m_Impl->getInt(std::move(propertyNameID));
}
...
void osc::MaterialPropertyBlock::setInt(UID propertyNameID, int v)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setInt(std::move(propertyNameID), std::move(v));
}
...
osc::Texture2D const* osc::MaterialPropertyBlock::getTexture(UID propertyNameID) const
{
    return m_Impl->getTexture(std::move(propertyNameID));
}

void osc::MaterialPropertyBlock::setTexture(std::string_view propertyName, Texture2D const& t)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setTexture(std::move(propertyName), std::move(t));
}

void osc::MaterialPropertyBlock::setTexture(UID propertyNameID, Texture2D const& t)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setTexture(std::move(propertyNameID), std::move(t));
}
...
glm::vec4 const* osc::MaterialPropertyBlock::getVector(UID propertyNameID) const
{
    return m_Impl->getVector(std::move(propertyNameID));
}
...
void osc::MaterialPropertyBlock::setVector(UID propertyNameID, glm::vec4 const& v)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setVector(std::move(propertyNameID), v);
}
...
glm::mat4 const* osc::MaterialPropertyBlock::getMatrix(UID propertyNameID) const
{
    return m_Impl->getMatrix(std::move(propertyNameID));
}
...
void osc::MaterialPropertyBlock::setMatrix(UID propertyNameID, glm::mat4 const& v)
{
    DoCopyOnWrite(m_Impl);
...
osc::Camera2::Camera2(Texture2D t) :
    m_Impl{std::make_shared<Impl>(std::move(t))}
{
}

osc::Camera2::Camera2(Camera2 const&) = default;
osc::Camera2::Camera2(Camera2&&) noexcept = default;
osc::Camera2& osc::Camera2::operator=(Camera2 const&) = default;
osc::Camera2& osc::Camera2::operator=(Camera2&&) noexcept = default;
osc::Camera2::~Camera2() noexcept = default;

glm::vec4 const& osc::Camera2::getBackgroundColor() const
{
    return m_Impl->getBackgroundColor();
}

void osc::Camera2::setBackgroundColor(glm::vec4 const& v)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setBackgroundColor(v);
}

osc::CameraProjection osc::Camera2::getCameraProjection() const
{
    return m_Impl->getCameraProjection();
}

void osc::Camera2::setCameraProjection(CameraProjection p)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setCameraProjection(std::move(p));
}

float osc::Camera2::getOrthographicSize() const
{
    return m_Impl->getOrthographicSize();
}

void osc::Camera2::setOrthographicSize(float v)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setOrthographicSize(std::move(v));
}

float osc::Camera2::getCameraFOV() const
{
    return m_Impl->getCameraFOV();
}

void osc::Camera2::setCameraFOV(float v)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setCameraFOV(std::move(v));
}

float osc::Camera2::getNearClippingPlane() const
{
    return m_Impl->getNearClippingPlane();
}

void osc::Camera2::setNearClippingPlane(float v)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setNearClippingPlane(std::move(v));
}

float osc::Camera2::getFarClippingPlane() const
{
    return m_Impl->getFarClippingPlane();
}

void osc::Camera2::setFarClippingPlane(float v)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setFarClippingPlane(std::move(v));
}

osc::Texture2D const* osc::Camera2::getTexture() const
{
    return m_Impl->getTexture();
}

void osc::Camera2::setTexture(Texture2D const& t)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setTexture(std::move(t));
}

void osc::Camera2::setTexture()
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setTexture();
}

int osc::Camera2::getPixelWidth() const
{
    return m_Impl->getPixelWidth();
}

int osc::Camera2::getPixelHeight() const
{
    return m_Impl->getPixelHeight();
}

float osc::Camera2::getAspectRatio() const
{
    return m_Impl->getAspectRatio();
}

std::optional<osc::Rect> osc::Camera2::getScissorRect() const
{
    return m_Impl->getScissorRect();
}

void osc::Camera2::setScissorRect(Rect const& r)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setScissorRect(r);
}

void osc::Camera2::setScissorRect()
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setScissorRect();
}

glm::vec3 const& osc::Camera2::getPosition() const
{
    return m_Impl->getPosition();
}

void osc::Camera2::setPosition(glm::vec3 const& p)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setPosition(p);
}

glm::vec3 const& osc::Camera2::getDirection() const
{
    return m_Impl->getDirection();
}

void osc::Camera2::setDirection(glm::vec3 const& d)
{
    DoCopyOnWrite(m_Impl);
    m_Impl->setDirection(d);
}

glm::mat4 const& osc::Camera2::getCameraToWorldMatrix() const
{
    return m_Impl->getCameraToWorldMatrix();
}

void osc::Camera2::render()
{
    DoCopyOnWrite(m_Impl);
    m_Impl->render();
}

bool osc::operator==(Camera2 const& a, Camera2 const& b)
{
    return a.m_Impl == b.m_Impl;
}
...
std::ostream& osc::operator<<(std::ostream& o, Camera2 const&)
{
    return o << "CameraNew()";
}

std::string osc::to_string(Camera2 const& c)
{
    return StreamToString(c);
}

size_t std::hash<osc::Camera2>::operator()(osc::Camera2 const& c) const
{
...
void osc::Graphics::DrawMesh(Mesh,
                             glm::vec3 const&,
                             Material,
                             Camera2&,
